...
func (m *MockImageFactory) NewLocal(arg0 string, arg1 bool) (image.Image2, error) {
	ret := m.ctrl.Call(m, "NewLocal", arg0, arg1)
	ret0, _ := ret[0].(image.Image2)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockImageFactory) NewRemote(arg0 string) (image.Image2, error) {
